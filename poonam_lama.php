                                ...
                                <div class="prt-team-member-single-content-area">
                                    ...
                                    <div class="prt-featured-wrapper"> 
                                        <div class="featured-thumbnail" data-aos="zoom-in" data-aos-duration="1500">
                                            <img width="300" height="300" class="img-fluid" src="images/team-member/Poonam Lama.png" alt="image">
                                        </div> 
                                    </div><!-- prt-featured-wrapper end-->
                                    <div class="prt-team-member-detail res-991-mt-30">
                                        <div class="prt-team-member-single-list">
                                            <h2 class="prt-team-member-single-title">Poonam Lama</h2>
                                            <h5 class="prt-team-member-single-position">Financial Consultant & Advisor</h5>
                                            <div class="prt-short-desc">
                                            <span style="color:darkgray">(B.Com, MMS - Marketing, Diploma in Shipping & Logistics)</span><br>  
                                            With 30+ years of work experience in Logistics, Telecommunications & Manufacturing sectors, Poonam comes with rich managerial experience and business acumen, in addition to her domain expertise as a licensed insurance and financial advisor.</div>
